      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-3 flex items-center justify-between">
        <div className="flex items-center gap-4">
          <button
            ...
            className="md:hidden inline-flex items-center justify-center rounded-md p-2 text-gray-600 hover:bg-gray-100 focus:outline-none focus:ring-2 focus:ring-lime-400"
            onClick={() => setOpen(o => !o)}
          >
            <svg
              className="h-6 w-6"
        ...
        <nav className="hidden md:flex items-center gap-8 text-sm font-medium">
          <Link to="/calendar" className="text-gray-600 hover:text-lime-600 transition-colors">Calendario</Link>
          <Link to="/training-plan" className="text-gray-600 hover:text-lime-600 transition-colors">Mi Plan</Link>
          <Link to="/races" className="text-gray-600 hover:text-lime-600 transition-colors">Carreras</Link>
          <Link to="/settings" className="text-gray-600 hover:text-lime-600 transition-colors">Ajustes</Link>
        </nav>
      ...
      >
        <div className="px-4 pt-2 pb-4 space-y-4 text-sm bg-white/95 backdrop-blur">
          ...
          <div className="border-t border-gray-100 pt-3 flex items-center justify-between">
            ...
            <button
              onClick={handleLogout}
              className="bg-lime-400 text-black text-xs font-semibold py-2 px-3 rounded-md hover:bg-lime-500"
            >Salir</button>
          </div>
        </div>
      </div>

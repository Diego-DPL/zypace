...
const PrivacyPage = () => (
  ...
  <main className="max-w-3xl mx-auto px-4 py-12 prose prose-sm sm:prose lg:prose-lg bg-white text-black dark:text-black">
    ...
    <h2>2. Canales del servicio</h2>
    <p>Zypace está disponible como aplicación web en <strong>www.zypace.com</strong> y como aplicación móvil nativa para <strong>iOS</strong> y <strong>Android</strong>. Esta política aplica a ambos canales por igual.</p>
    ...
    <ul>
      ...
      <li><strong>Notificaciones push (app móvil):</strong> si concedes permiso en la app móvil, almacenamos tus preferencias de recordatorio (hora del día, días activos). El sistema operativo del dispositivo puede asignar un token de notificación anónimo gestionado por Apple (APNs) o Google (FCM); Zypace no almacena ni comparte dicho token con terceros.</li>
      <li><strong>Datos del dispositivo (app móvil):</strong> sistema operativo, versión de la app y un identificador de instalación anónimo generado por Expo, usados exclusivamente para diagnóstico técnico y entrega de notificaciones locales.</li>
    ...
    <h2>6. Uso de datos de Strava</h2>
    ...
    <p className="text-xs text-gray-500">Última actualización: 20/05/2026</p>
  </main>
  </>
);

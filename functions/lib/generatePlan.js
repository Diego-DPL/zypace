...
exports.generatePlan = (0, https_1.onCall)({ region: 'europe-west1', secrets: [openAiApiKey, openAiModel], timeoutSeconds: 540, memory: '512MiB' }, async (request) => {
    var _a;
    ...
    const strengthDays = includeStrength ? Math.min(Math.max(Number(config === null || config === void 0 ? void 0 : config.strength_days_per_week) || 1, 1), 3) : 0;
  ...
  • Martes: 4-8 × 1000-2000m a ${(zones === null || zones === void 0 ? void 0 : zones.z4) || 'ritmo 10k'}, recup 90-120s trote
  • Jueves: 5-8 × 1000m a ${(zones === null || zones === void 0 ? void 0 : zones.z4) || 'ritmo 10k'}, recup 90s trote (sesión algo más fácil)
  • Resto: Z1 ESTRICTO a ${(zones === null || zones === void 0 ? void 0 : zones.z1) || 'ritmo muy suave'} — cero "moderado", cero Z3
  ...
  • Tipo A — VO2max (Z5): 4-8 × 3-5min a ${(zones === null || zones === void 0 ? void 0 : zones.z5) || 'ritmo 5k'}, recuperación activa igual al esfuerzo
  • Tipo B — Umbral (Z4): 2-4 × 10-15min a ${(zones === null || zones === void 0 ? void 0 : zones.z4) || 'ritmo 10k'}, recup 3min trote suave
  • Rodaje LARGO: siempre en Z1 (${(zones === null || zones === void 0 ? void 0 : zones.z1) || 'conversacional'}), cuenta como volumen base, NO como calidad
  • Rodajes suaves: ${(zones === null || zones === void 0 ? void 0 : zones.z1) || 'ritmo conversacional'} — si tienes dudas sobre el ritmo, ve más lento
...
REGLAS OBLIGATORIAS — INCUMPLIR ESTAS REGLAS INVALIDA EL PLAN:
  ...
  8. Los rodajes suaves SIEMPRE en Z1 (${(zones === null || zones === void 0 ? void 0 : zones.z1) || 'ritmo conversacional'}), nunca "moderado"
...
Marca previa: ${(lastRace === null || lastRace === void 0 ? void 0 : lastRace.distance_km) ? `${lastRace.distance_km}km en ${lastRace.time || '-'}` : 'no'}
...
Genera el plan completo desde ${startISO} hasta ${raceISO}.`;
    ...
    async function callResponsesAPI(activeModel) {
        ...
        if (!res.ok)
            throw new Error(((_a = data === null || data === void 0 ? void 0 : data.error) === null || _a === void 0 ? void 0 : _a.message) || `OpenAI fallo (${res.status})`);
        const outputs = [];
            ...
            for (const wd of Array.from(runDaySet)) {
                if (wd === sundayWd) {
                    dayPlans[wd] = {
                        ...
                        details: `${longRunKm}km completamente en Z1 (${(zones === null || zones === void 0 ? void 0 : zones.z1) || 'ritmo conversacional'}). Hidrata cada 20-25min. Mantén el ritmo constante y cómodo.`,
                    ...
                    dayPlans[wd] = {
                        ...
                        details: `${km}km en Z1 a ${(zones === null || zones === void 0 ? void 0 : zones.z1) || 'ritmo conversacional'}. Mantén una conversación fluida en todo momento.`,
    ...
    parsedPlan.plan.forEach(d => {
        if (!/^\d{4}-\d{2}-\d{2}$/.test(d.date))
            throw new https_1.HttpsError('internal', `Fecha inválida en plan: ${d.date}`);
        if (typeof d.description !== 'string')
            throw new https_1.HttpsError('internal', 'Descripción inválida en un día');
